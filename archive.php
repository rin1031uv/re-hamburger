...
<?php get_header(); ?>
  <main>
<!--img部分-->
    <div class="p-top__image-container p-top-archive__image-container">
      <img class="p-top__image p-top-archive__image" src="<?php echo get_stylesheet_directory_uri(); ?>/images/page-title_arcive.jpg">
      <h2 class="p-top__title p-top-archive__title">MENU:</h2>
<!--▼▼menu横カテゴリ表示▼▼-->

      <p class="p-top-archive__subtitle"><?php single_cat_title(); ?></p>
<!--▲▲menu横カテゴリ表示▲▲-->
    </div>
<!--説明文エリア-->
